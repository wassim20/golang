    ...
    "definitions": {
        ...
        "MailinglistDetails": {
            ...
            "properties": {
                ...
                "created_at": {
                    "description": "CreatedAt is the timestamp indicating when the mailinglist entry was created.",
                    "type": "string"
                },
                "created_by_user": {
        ...
        "MailinglistsPagination": {
            ...
            "properties": {
                ...
                "totalCount": {
                    "description": "TotalCount is the total number of mailinglists in the entire list.",
                    "type": "integer"
                }
            }
        },
        ...
        "domains.Contact": {
            ...
            "properties": {
                ...
                "mailinglists": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domains.Mailinglist"
                    }
                },
                "phoneNumber": {
                    "description": "contact's email address (unique)",
        ...
        "domains.Mailinglist": {
            ...
            "properties": {
                "companyID": {
                    "description": "ID of the company to which the mailinglist belongs",
                    "type": "string"
                },
                "contacts": {
                    "description": "List of contacts associated with the",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domains.Contact"
                    }
                ...
                "createdByUserID": {
                    "description": "ID of the user who created the mailinglist",
                    "type": "string"
                },
                "deletedAt": {
                    "$ref": "#/definitions/gorm.DeletedAt"
                ...
                "description": {
                    "description": "The mailinglist's description",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
                ...
                "name": {
                    "description": "The mailinglist's name",
                    "type": "string"
                },
                "tags": {
                    "description": "List of tag's uuid associated with the mailinglist",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
